        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div className="flex flex-col items-center md:items-start space-y-3 sm:space-y-4">
            ...
            <div className="flex flex-col space-y-2 text-center md:text-left">
              <a href="#features" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">Features</a>
              <a href="#social-proof" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">Testimonials</a>
              <a href="#faq" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">FAQ</a>
              <a href="#waitlist" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">Join Waitlist</a>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start space-y-3 sm:space-y-4">
            ...
            <div className="flex flex-col space-y-2 text-center md:text-left">
              <a 
                ...
                className="text-sm sm:text-base text-gray-400 hover:text-blue-400 transition-colors flex items-center space-x-2 justify-center md:justify-start"
              >
